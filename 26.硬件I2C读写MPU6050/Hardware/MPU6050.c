...
{
//	MyI2C_Start();
//	MyI2C_SendByte(MPU6050_ADDRESS);//写从机地址，最后一位为读写位
//	MyI2C_ReceiveAck();
//	MyI2C_SendByte(RegAdress);//写寄存器地址 
//	MyI2C_ReceiveAck();
//	MyI2C_SendByte(Data);
//	MyI2C_ReceiveAck();
//	MyI2C_Stop(); 	
...
//	MyI2C_Init();
	...
	MPU6050_WriteReg(MPU6050_GYRO_CONFIG,0x18);//陀螺仪使能
	MPU6050_WriteReg(MPU6050_ACCEL_CONFIG,0x18);//加速度计使能配置
}
